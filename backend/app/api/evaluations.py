...
def list_evaluations(
    ...
    items = evaluation_service.get_evaluations(db, question_id, student_id, passed, created_by=owner)
...
def export_evaluations_excel(
    ...
    """Export evaluations as Excel file, optionally filtered by date range."""
    ...
    evals = query.order_by(Evaluation.evaluated_at.desc()).all()
    ...
    headers = ["#", "Student Name", "Student ID", "Question", "Topic", "Score", "Max Score", "Percentage", "Status", "Date", "Time"]
